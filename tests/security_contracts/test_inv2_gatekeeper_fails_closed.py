...
def test_fuzz_unknown_tool_names_never_green(tool_name, security_config):
    ...
    known_green = {
        "read_file", "write_file", "edit_file", "list_directory", "exec_command",
        "shell_exec", "shell", "run_python", "search_memory", "get_entity",
        "search", "list_jobs", "web_search", "web_fetch", "web_news_search",
        "search_and_read", "browse_url", "search_procedures",
        "media_analyze_image", "media_extract_text", "media_transcribe_audio",
        "media_resize_image", "get_core_memory", "get_recent_episodes",
        "memory_stats", "record_procedure_usage", "browse_page_info",
        "browse_screenshot", "analyze_code", "list_skills",
        "search_community_skills", "reddit_scan", "reddit_leads",
        "reddit_refine", "reddit_discover_subreddits", "reddit_templates",
        "read_pdf", "read_ppt", "read_docx", "template_list",
        "list_remote_agents", "git_status", "git_diff", "git_log",
        "search_files", "find_in_files", "db_query", "db_schema",
        "create_chart", "create_table_image", "chart_from_csv",
        "set_reminder", "list_reminders", "send_notification",
        "get_clipboard", "set_clipboard", "screenshot_desktop",
        "screenshot_region", "computer_screenshot", "calendar_today",
        "calendar_upcoming", "calendar_check_availability",
        "identity_recall", "identity_state", "identity_reflect",
        "identity_dream", "knowledge_synthesize", "knowledge_contradictions",
        "knowledge_timeline", "knowledge_gaps", "vault_list", "vault_search",
        "vault_read", "docker_ps", "docker_logs", "docker_inspect",
        "api_list", "remote_list_hosts", "remote_test_connection",
        "list_background_jobs", "check_background_job", "read_background_log",
        "wait_background_job", "arc_status", "arc_replay", "atl_status",
        "atl_journal", "kanban_create_task", "kanban_update_task",
        "kanban_list_tasks", "social_scan", "social_leads",
    }
    ...
    assert decision.risk_level != RiskLevel.GREEN, (
        f"Unknown tool '{tool_name}' classified as GREEN"
    )
...
def test_fuzz_unknown_always_orange_or_higher(tool_name, security_config):
    ...
    known_tools = {
        ...
        "exec_command", "shell_exec", "shell", "run_python",
        "search_memory", "get_entity", "search", "list_jobs",
        "web_search", "web_fetch", "save_to_memory", "add_entity",
        "email_send", "delete_file", "vault_delete",
    }
