...
if TYPE_CHECKING:
    from jarvis.evolution.autonomous_learner import LearningTask
...
class EvolutionRAG:
    ...
    Storage lives at ``~/.jarvis/data/evolution_rag.db`` by default.
    ...
    def __init__(self, db_path: str | Path | None = None) -> None:
        if db_path is None:
            db_path = Path.home() / ".jarvis" / "data" / "evolution_rag.db"
