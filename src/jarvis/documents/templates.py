...
Templates are stored as .typ files in ~/.jarvis/templates/documents/.
...
class TemplateManager:
    ...
    Templates live in ``~/.jarvis/templates/documents/`` as ``.typ`` files
    ...
    def __init__(self, templates_dir: Path | None = None) -> None:
        self._templates_dir = templates_dir or Path.home() / ".jarvis" / "templates" / "documents"
