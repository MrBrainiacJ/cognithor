...
Konfiguration:
  - COGNITHOR_SLACK_BOT_TOKEN: Bot-Token (xoxb-...)
  - COGNITHOR_SLACK_APP_TOKEN: App-Token fuer Socket Mode (xapp-...)
  - COGNITHOR_SLACK_CHANNEL: Standard-Kanal fuer Benachrichtigungen
    ...
    async def start(self, handler: MessageHandler) -> None:
        ...
        if self.app_token:
            ...
            logger.info(
                ...
                "Setze COGNITHOR_SLACK_APP_TOKEN für bidirektionalen Betrieb."
            )
