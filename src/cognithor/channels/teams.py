...
Konfiguration:
  - COGNITHOR_TEAMS_APP_ID: Bot-App-ID (Azure AD)
  - COGNITHOR_TEAMS_APP_PASSWORD: Bot-App-Passwort
  - COGNITHOR_TEAMS_WEBHOOK_HOST: Webhook-Host (Default: 127.0.0.1)
  - COGNITHOR_TEAMS_WEBHOOK_PORT: Webhook-Port (Default: 3978)
