...
Konfiguration: COGNITHOR_TELEGRAM_TOKEN und COGNITHOR_TELEGRAM_ALLOWED_USERS
Optional fuer Webhook: COGNITHOR_TELEGRAM_USE_WEBHOOK, COGNITHOR_TELEGRAM_WEBHOOK_URL
"""
...
from cognithor.utils.circuit_breaker import CircuitBreaker, CircuitBreakerOpen
