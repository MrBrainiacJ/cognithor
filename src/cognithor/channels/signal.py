...
Konfiguration:
  - COGNITHOR_SIGNAL_API_URL: signal-cli-rest-api Basis-URL (z.B. http://localhost:8080)
  - COGNITHOR_SIGNAL_PHONE: Registrierte Telefonnummer (+49...)
  - COGNITHOR_SIGNAL_ALLOWED_NUMBERS: Komma-getrennte Whitelist
...
class SignalChannel(Channel):
    ...
    def __init__(
        ...
        *,
        ...
        self._workspace_dir = workspace_dir or Path.home() / ".cognithor" / "workspace" / "signal"
