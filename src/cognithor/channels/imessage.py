...
Konfiguration (macOS nativ):
  - COGNITHOR_IMESSAGE_ALLOWED_HANDLES: Komma-getrennte Handle-Whitelist (+49..., email@...)

Konfiguration (BlueBubbles):
  - COGNITHOR_IMESSAGE_BB_URL: BlueBubbles Server URL (z.B. http://localhost:1234)
  - COGNITHOR_IMESSAGE_BB_PASSWORD: BlueBubbles Server-Passwort
  - COGNITHOR_IMESSAGE_ALLOWED_HANDLES: Komma-getrennte Handle-Whitelist
