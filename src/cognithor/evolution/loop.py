...
class EvolutionLoop:
    ...
    def _create_builder_for_goal(self, goal: Any) -> Any | None:
        ...
        try:
            ...
            from cognithor.evolution.knowledge_builder import KnowledgeBuilder
            from cognithor.evolution.models import _slugify
    ...
    async def thinking_cycle(self) -> EvolutionCycleResult:
        ...
        if thought.proposed_actions and self._mcp_client:
            from cognithor.evolution.action_queue import ActionQueue, ATLAction
    ...
    def _update_goal_progress_from_metrics(self, goals: list) -> None:
        ...
        index_base = Path.home() / ".cognithor" / "evolution" / "indexes"
    ...
    def _save_checkpoint(self, cp: EvolutionCheckpoint) -> None:
        ...
        if not self._checkpoint_store:
            return
        from cognithor.core.checkpointing import PersistentCheckpoint
                    ...
                    if uses >= 5 and sr < 0.5:
                        ...
                        try:
                            ...
                            if _kanban and _kanban_cfg and _kanban_cfg.auto_create_from_evolution:
                                from cognithor.kanban.sources import EvolutionTaskAdapter
