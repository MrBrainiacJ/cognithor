...
from cognithor.identity.cognitio.existential import ExistentialLayer
from cognithor.identity.cognitio.garbage_collector import GarbageCollector
...
from cognithor.identity.cognitio.narrative import NarrativeSelf
from cognithor.identity.cognitio.predictive import PredictiveEngine
from cognithor.identity.cognitio.reality_check import RealityCheck
from cognithor.identity.cognitio.somatic import SomaticState
from cognithor.identity.cognitio.temporal import TemporalDensityTracker
    ...
    def _load_state(self, filepath: str) -> None:
        ...
        try:
            ...
            if "relational" in data:
                from cognithor.identity.cognitio.character import RelationalProfile
