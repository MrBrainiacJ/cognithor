...
from cognithor.models import ActionPlan, PlannedAction, ToolResult
from cognithor.utils.logging import get_logger

log = get_logger(__name__)

try:
    from cognithor.core.vision import build_vision_message, format_for_backend
...
class CUAgentExecutor:
    ...
    async def _extract_text_from_screen(self) -> str:
        ...
        try:
            from cognithor.mcp.computer_use import _take_screenshot_b64
